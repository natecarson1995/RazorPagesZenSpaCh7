...
namespace RazorPages.Migrations
{
    ...
    [Migration("20211101002253_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 2,
                            ConfirmPassword = "JoJoSchmoe1234?",
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 31, 20, 22, 53, 533, DateTimeKind.Local).AddTicks(9038),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2021, 10, 31, 20, 22, 53, 536, DateTimeKind.Local).AddTicks(4379),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 31, 20, 22, 53, 536, DateTimeKind.Local).AddTicks(4431),
                            ServicesID = 5
                        });
                });
