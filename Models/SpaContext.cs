    ...
    public class SpaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Client>().HasData(
                new Client { ID = 1, FirstName = "Flo", LastName = "Schmoe", Username = "Flo", Email = "flo@schmoe.net", Password = "FloSchmoe1234*", ConfirmPassword= "FloSchmoe1234*" },
                new Client { ID = 2, FirstName = "Jo", LastName = "Schmoe", Username = "JoJo", Email = "jojo@schmoe.net", Password = "JoJoSchmoe1234?", ConfirmPassword = "JoJoSchmoe1234?" },
                new Client { ID = 3, FirstName = "Truly", LastName = "Schmoe", Username = "Truly", Email = "truly@schmoe.net", Password = "Truly9876**", ConfirmPassword = "Truly9876**" }
            );
